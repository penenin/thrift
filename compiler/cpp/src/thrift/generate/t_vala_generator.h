...
class t_vala_generator : public t_oop_generator
{
...
public:
  t_vala_generator(t_program* program, const map<string, string>& parsed_options, const string& option_string);
  ...
  void generate_vala_property(ostream& out, t_field* tfield, bool isPublic, bool includeIsset = true, string fieldPrefix = "");
  ...
  void generate_vala_struct(t_struct* tstruct, bool is_exception);
  void generate_vala_struct_definition(ostream& out, t_struct* tstruct, bool is_xception = false, bool in_class = false, bool is_result = false);
  void generate_vala_struct_reader(ostream& out, t_struct* tstruct);
  void generate_vala_struct_result_writer(ostream& out, t_struct* tstruct);
  void generate_vala_struct_writer(ostream& out, t_struct* tstruct);
  ...
  void generate_vala_doc(ostream& out, t_field* field);
  void generate_vala_doc(ostream& out, t_doc* tdoc);
  void generate_vala_doc(ostream& out, t_function* tdoc);
  void generate_vala_docstring_comment(ostream& out, string contents);
  ...
  void start_vala_namespace(ostream& out);
  void end_vala_namespace(ostream& out);

  string vala_type_usings() const;
  string vala_thrift_usings() const;
...
private:
  ...
  string make_valid_vala_identifier(string const& fromName);
